...
export function pickbanStepMock(firstPlayerId: string, secondPlayerId: string, physics: Physics, maps?: MapInterface[], bannedByFirst?: boolean[], bannedBySecond?: boolean[]): PickbanStepMessageInterface {
    return {
