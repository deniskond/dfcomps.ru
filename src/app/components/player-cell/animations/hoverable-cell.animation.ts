...
export const hoverableCellAnimation = trigger('hoveredCell', [
    ...
    transition(`${HOVERABLE_CELL_TRANSPARENT_HOVERED_STATE} => ${HOVERABLE_CELL_TRANSPARENT_NORMAL_STATE}`, [animate(500)]),
    transition(`${HOVERABLE_CELL_TRANSPARENT_NORMAL_STATE} => ${HOVERABLE_CELL_TRANSPARENT_HOVERED_STATE}`, [animate(100)]),
]);
