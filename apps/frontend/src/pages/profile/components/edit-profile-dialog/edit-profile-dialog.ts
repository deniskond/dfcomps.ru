...
export class EditProfileDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    const selectedCountry = this.countries.find((country: CountryInterface) => country.shortName === this.data.country);
  ...
  public onEditProfileClick(): void {
    ...
    this.profileService
      .updateProfile$(this.editProfileForm.get('nick')!.value, this.fileInput.nativeElement.files[0], countryShortName)
