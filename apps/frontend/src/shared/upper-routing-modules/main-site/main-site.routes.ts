...
export const mainSiteRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'archive',
        loadChildren: () => import('./../../pages/archive/archive.page.module').then((m) => m.ArchivePageModule),
      },
      {
        path: 'movies',
      ...
      {
        path: 'rules',
        loadChildren: () => import('./../../pages/rules/rules.page.module').then((m) => m.RulesPageModule),
      },
      {
        path: 'teams',
