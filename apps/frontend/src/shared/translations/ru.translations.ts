export const RUSSIAN_TRANSLATIONS: Record<string, string> = {
  ...
  uploadWrRules: `Можно загрузить любое демо на карте, на которой демо ещё не загружено, либо демо, тайм которого строго меньше текущего рекорда на карте. К загруженным демо применяются проверки валидации стандартного конфига и правила оффлайн-турниров.`,
