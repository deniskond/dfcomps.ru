export const RUSSIAN_TRANSLATIONS: Record<string, string> = {
  ...
  mapWasNotFoundOnWS: 'Карта не найдена на',
  mapWasOnCompetition: 'Карта была на',
  mapWasFoundOnWS: 'Карта найдена на',
  ...
  seasonPeriod: '27 Июня 2026 - 26 Декабря 2026',
  ...
  uploadWrRules: `Можно загрузить любое демо на карте, на которой демо ещё не загружено, либо демо, тайм которого строго меньше текущего рекорда на карте. При загрузке валидируется только соответствие всех настроек стандартному конфигу и отсутствие тайм-ресета. Все виды овербаунсов и использование особенностей карт в онлайне разрешены, будут удаляться только демки с читами.`,
  choosePlayer: 'Выберите игрока',
  chooseDemo: 'Выберите демо (.dm_68)',
