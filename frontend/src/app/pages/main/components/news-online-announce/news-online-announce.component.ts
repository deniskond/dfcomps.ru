...
export class NewsOnlineAnnounceComponent implements OnInit, OnChanges {
    ...
    ngOnInit(): void {
        this.iframeLink1 = this.domSantizer.bypassSecurityTrustResourceUrl(`https://player.twitch.tv/?channel=${this.news.twitch1}}&autoplay=false`);
        this.iframeLink2 = this.domSantizer.bypassSecurityTrustResourceUrl(`https://player.twitch.tv/?channel=${this.news.twitch2}}&autoplay=false`);
    }
